...
%>
          <tr>
          <th scope="col"><a href="myCart.jsp"><em class='fas fa-arrow-circle-left'> Back</em></a></th>
 ...
 %>     
    ...
    <%sno=sno+1; %>      
           <td><%out.println(sno); %></td>
            ...
            <td><em class="fa fa-inr"></em> <%=rs.getString(4) %></td>
            <td><%=rs.getString(8) %> </td>
            <td><em class="fa fa-inr"></em> <%=rs.getString(10) %></td>
            </tr>
 <% }
...
<div class="right-div">
<h3>Pay online on Batch11@pay.com</h3>
...
<button class="button" type="submit">Proceed to generate bill and save <em class='far fa-arrow-alt-circle-right'></em></button>
